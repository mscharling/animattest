...
Vi viser første punkt: Antag $n$ er et lige tal. Det betyder, at vi kan skrive $n=2m$, hvor $m$ er et heltal forskelligt fra 0, jf. {prf:ref}`ligeoguligetal`. Ved brug af vores potensregneregler får vi så
...
Vi viser anden punkt: Antag $n$ er et ulige tal. Det betyder nu, at vi kan skrive $n=2m-1$, hvor $m$ stadig er et heltal forskelligt fra 0, jf. {prf:ref}`ligeoguligetal`. Ved brug af vores potenseregneregler får vi 
...
Afslutningsvis har vi fra {numref}`Kapitel %s<negativetal>`, at $-a=-1\cdot a$ og ved brug af Regneregel $\eqref{p2}$ har vi
